...
export const SAMPLE_PROBLEMS = [
  ...
  {
    id: "q78", type: "fill_blank", difficulty: "fast",
    question: "평행한 두 직선이 한 직선과 만날 때, 같은 쪽에 있는 두 각(한 쪽 내각 쌍)의 합 = [___]°",
    answer: "180",
    explain: "평행선에서 엇각이 같고 한 직선 위 두 각의 합이 180°이므로, 같은 쪽 내각끼리 합은 180°. 평행선+꺾은선 문제에서 자주 쓰이는 성질.",
    figure: "parallel-cut",
  },
  {
  ...
  },
  {
    ...
    answer: "36",
    explain: "∠B=∠C=β(이등변), ∠A=α라 하자. α+2β=180°. BD가 ∠B 이등분 → ∠DBC=β/2. BD=BC → △BDC 이등변으로 밑각 ∠BDC=∠BCD=β. △ABD에서 외각정리로 ∠BDC=α+∠ABD=α+β/2. 두 ∠BDC 값이 같으므로 β=α+β/2 → α=β/2. α+2β=180°에 대입: β/2+2β=180° → β=72°, α=36°.",
    figure: "iso-bd-eq-bc-bisect",
  },
  {
